...
client.on("guildMemberAdd", async member => {
 ...
 client.channels.cache.get(chx).send("Willkommen auf unseren Server " + member.user.username, attachment);
...
client.on("ready", () => {
    ...
    console.log("Kiel Bot ist Bereit und Online!")
});
client.on("message", async message => {
if(!message.guild) return;
...
client.on("ready", () => {
    client.user.setActivity(`Mach ks!help für commands!`, { type: "WATCHING"})
})
